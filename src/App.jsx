                    ...
                    <div className="container mx-auto max-w-6xl">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                            <div className="relative h-[300px] md:h-[500px]">
                                {content.features_image_1 && <div className="absolute top-0 left-0 w-3/5 h-3/5 rounded-3xl overflow-hidden shadow-deep-blue z-10"><img src={content.features_image_1} className="w-full h-full object-cover" alt="Office"/></div>}
                                {content.features_image_2 && <div className="absolute bottom-0 right-0 w-3/5 h-3/5 rounded-3xl overflow-hidden shadow-deep-blue z-20 border-4 border-white"><img src={content.features_image_2} className="w-full h-full object-cover" alt="Meeting"/></div>}
