---
name: Firebase Functions 500 에러 해결 가이드
overview: Firebase Functions에서 발생하는 500 에러를 진단하고 해결하기 위한 단계별 가이드를 작성합니다. 에러 로그 확인 방법, 일반적인 원인들, 그리고 각 원인별 해결 방법을 포함합니다.
todos:
  - id: create-error-guide
    content: Firebase Functions 500 에러 해결 가이드 문서 작성
    status: completed
isProject: false
---
...
3. **배포 환경 환경 변수 설정**
```bash
firebase functions:config:set g2b.api_key="your-api-key-here"
